...
#Run log file is defined in tmux process

TEXT_PCA_DIM   = 96
IMG_PCA_DIM    = 64
FUSED_PCA_DIM  = 64

PER_REC_ROOT = "./outputs_per_record_IE_Radio" #Adjust by cases --> Ready to change to the main pipeline again with 17 radiomics features + Image Encoder + Textual Encoder
